...
async function getsongs(folder) {      //i.e getsongs function will take folder name as parameter so as to 
    currfolder = folder;
    let a = await fetch(`/${folder}/._Ambarsariya_Fukrey__Song_By_Sona_Mohapatra___Pulkit_Samra`)   //here we removedthe /songs by /${folder} becoz directly we want to create dynamic folders  which are related to the cards.
